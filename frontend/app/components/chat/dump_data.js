const data = [
    {
        meeting: {
            meetingId: 1,
            meetingName: "플로깅하러 당장 모여",
            meetingImg: "https://www.tripade.com/data/images/reviews/3923/9ca86ec8852edaeea35c94b4ebd9dac5.jpg",
            memberCnt: 3,
            memberMax: 6,
            meetingPlace: "석촌호수",
            item: {
        ...
        chatting: {
            lastMsg: "길 잃어버렸어요 어디로 가면 되나요ㅠㅠ 혹시 벌써 모여계세요?",
            lastTime: "2022-04-29 09:50:00.0",
            unReadCnt: 13
        }, 
    },
    {
        meeting: {
            meetingId: 5,
            meetingName: "야경보면서 쓰줍하실 분",
            meetingImg: "https://t1.daumcdn.net/cfile/tistory/994B9A475ACC1A360C",
            memberCnt: 5,
            memberMax: 5,
            meetingPlace: "남산타워",
            item: {
        ...
        chatting: {
            lastMsg: "조심해서 들어가세요~!!",
            lastTime: "2022-04-27 19:50:00.00",
            unReadCnt: 2
        }, 
    },
    {
