            ...
            <View style={styles.overlay}>
                ...
                >
                    ...
                    <BadgeDescComponent>
                        { badge.isOwned
                        ?
                        <BadgeDescImg source={{uri: badge.badgeImg}}></BadgeDescImg>
                        :
                        <View>
                            <BadgeDescImg style={{ tintColor: 'gray' }} source={{uri: badge.badgeImg}}></BadgeDescImg>
                            <BadgeDescImg style={{ position: 'absolute', opacity: 0.3 }} source={{uri: badge.badgeImg}}></BadgeDescImg>
                        </View>
                        }
